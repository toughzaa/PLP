...
public class TreesCountDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(TreesCountDriver.class);
    ...
    public static void main(String[] args) throws Exception {
        TreesCountDriver exTreesCount = new TreesCountDriver();
