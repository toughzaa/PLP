...
import cs.bigdata.Lab2.WordDocCountMapper;
import cs.bigdata.Lab2.WordDocCountReducer;

import org.apache.hadoop.io.IntWritable;
import org.apache.hadoop.io.Text;

public class WordDocCountDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(WordDocCountDriver.class);
        job.setMapperClass(WordDocCountMapper.class);
        job.setReducerClass(WordDocCountReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        WordDocCountDriver exWordCount = new WordDocCountDriver();
