...
import cs.bigdata.Lab2.WordCountMapper;
import cs.bigdata.Lab2.WordCountReducer;
...
public class WordCountDriver extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("Word frequency for each doc");
    ...
    public static void main(String[] args) throws Exception {
        WordCountDriver exWordCount = new WordCountDriver();
